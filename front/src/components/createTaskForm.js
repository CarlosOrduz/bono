    ...
    return (              
      <>
        ...
        <Form.Group >
          ...
          <Form.Control type="text" placeholder="Ej. Tarea1" onChange={handleChangeTitle}/>
         
        </Form.Group>
      
        <Form.Group >
          <Form.Label>Descripción de la tarea</Form.Label>
          <Form.Control  as="textarea" placeholder="Descripción de la tarea" onChange={handleChangeDesc} />
        </Form.Group>
